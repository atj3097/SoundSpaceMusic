...
-(void)loadAudioFiles {
    ...
    NSString * guitarSourcePath = [[NSBundle mainBundle] pathForResource:@"Rick Ross - Gold Roses (Audio) ft. Drake" ofType:@"mp3"];
    NSString * drumsSourcePath = [[NSBundle mainBundle] pathForResource:@"Rick Ross - Gold Roses (Audio) ft. Drake" ofType:@"mp3"];
